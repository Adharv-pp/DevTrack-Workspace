...
from PyQt5.QtWidgets import (
    ...
    QGroupBox, QGridLayout, QStackedWidget, QLineEdit
)
...
class Dashboard(QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("DevTrack Pro")
        ...
        for btn in (self.btn_dash, self.btn_proj, self.btn_inv, self.btn_cli): side_layout.addWidget(btn)
        ...
        self.page_proj = self.create_projects_page()
        self.page_inv = self.create_invoices_page()
        self.page_cli = self.create_clients_page()

        self.stacked.addWidget(self.page_dash)
        self.stacked.addWidget(self.page_proj)
        self.stacked.addWidget(self.page_inv)
        self.stacked.addWidget(self.page_cli)
    ...
    # ================= PAGE 1: DASHBOARD (Restored to original layout) =================
    ...
    # ================= PAGE 2: PROJECTS (Upgraded GitHub API) =================
    def create_projects_page(self):
        ...
        # Upgraded GitHub Card with Search Bar
    ...
    def api_github(self):
        ...
        try:
            ...
            # Account for users who don't set a public name
